...
$com = $db->query("SELECT COUNT(*) AS id FROM tbl_product");
$user = $db->query("SELECT COUNT(*) AS id FROM login");
?>
<?php
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                ...
                                <div class="card-body" style="text-align: center;"><?= $m['id']; ?>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="card bg-success text-white mb-4">
                                ...
                                <div class="card-body" style="text-align: center;"><?= $u['id']; ?>
                                    <p>Utilisateur</p>
                                </div>
                                <?php } ?>
                                <div class="card-footer d-flex align-items-center justify-content-between">
